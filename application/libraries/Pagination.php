...
class CI_Pagination {
	...
	var $cur_tag_open		= '<span class="num active">';
	...
	function create_links()
	{
		...
		if  ($this->first_link !== FALSE AND $this->cur_page > ($this->num_links + 1))
		{
			...
			$output .= $this->first_tag_open.'<a '.$this->anchor_class.'href="'.$first_url.'" class="first_link">'.$this->first_link.'</a>'.$this->first_tag_close;
		}
